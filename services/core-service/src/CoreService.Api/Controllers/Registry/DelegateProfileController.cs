/*
 * File: services/core-service/src/CoreService.Api/Controllers/Registry/DelegateProfileController.cs
 *
 * Scopo
 * -----
 ...
 * self-service del delegato autenticato sul dominio Registry.
 ...
 * - Aggiornare il profilo del delegato autenticato.
...
namespace CoreService.Api.Controllers.Registry
{
    ...
    public sealed class DelegateProfileController : ControllerBase
    {
        // Servizio applicativo incaricato della gestione del profilo del delegato autenticato.
        private readonly DelegateProfileService _delegateProfileService;

        /*
         * Inizializza il controller del profilo delegato con il servizio applicativo
         * usato per le operazioni self-service del ruolo Delegate.
         */
        public DelegateProfileController(DelegateProfileService delegateProfileService)
        {
            _delegateProfileService = delegateProfileService
                ?? throw new ArgumentNullException(nameof(delegateProfileService));
        }
        ...
        public async Task<IActionResult> Get(CancellationToken cancellationToken)
        {
            ...
            // Delega al servizio profilo il recupero del profilo del delegato corrente.
            var result = await _delegateProfileService
        ...
        /*
         * Crea o aggiorna il profilo del delegato autenticato.
         */
        [HttpPut("me/profile")]
            ...
            CancellationToken cancellationToken)
        {
            ...
            // Delega al servizio profilo il salvataggio del profilo del delegato corrente.
            var result = await _delegateProfileService
