/*
 * File: services/core-service/src/CoreService.Domain/Registry/PasswordResetToken.cs
 *
 * Scopo
 * -----
 * Definire l'entità di dominio che rappresenta un token
 * utilizzato per il reset della password di un account utente.
 *
 * Ruolo nel sistema
 * -----------------
 ...
 * il workflow di recupero credenziali e reimpostazione password
 * tramite link o token monouso.
 *
 * Responsabilità principali
 * -------------------------
 * - Identificare univocamente il token di reset password.
...
{
    // Identificativo univoco del record di token di reset password.
    public Guid Id { get; set; }

    // Identificativo dell'utente a cui il token di reset appartiene.
